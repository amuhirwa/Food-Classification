...
preprocessor = FoodDataPreprocessor(data_dir=DATA_DIR)i import FastAPI, File, UploadFile, HTTPException, BackgroundTasks
...
try:
    ...
    from src.database import MLOpsDatabase
except ImportError:
    # Fallback import
    ...
    from database import MLOpsDatabase
